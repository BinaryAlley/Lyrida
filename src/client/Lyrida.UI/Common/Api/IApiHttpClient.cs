...
public interface IApiHttpClient
{
    ...
    Task<BlobDataEntity> GetBlobAsync(string endpoint, string? token = null, Language language = Language.English, EnvironmentType environment = EnvironmentType.LocalFileSystem, PlatformType platform = PlatformType.Unix);
    ...
    Task<string> PutAsync<TEntity>(string endpoint, TEntity entity, string? token = null, Language language = Language.English, EnvironmentType environment = EnvironmentType.LocalFileSystem, PlatformType platform = PlatformType.Unix);
    ...
    Task<string> PostAsync<TEntity>(string endpoint, TEntity entity, string? token = null, Language language = Language.English, EnvironmentType environment = EnvironmentType.LocalFileSystem, PlatformType platform = PlatformType.Unix);
    #endregion
}