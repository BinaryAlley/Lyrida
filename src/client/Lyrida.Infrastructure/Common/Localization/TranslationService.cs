...
public class TranslationService : ITranslationService
{
    ...
    public TranslationService(IAppConfig appConfig)
    {
        ...
        translations = new TranslationsCollection
        {
            ...
            (Terms.Agreement1, "Prin apăsarea butonului \"Înregistrare\", sunteți de acord cu", "By clicking \"Sign up\", you agree to our", "Durch Klicken auf \"Registrieren\" erklären Sie sich mit unseren"),
            (Terms.Agreement2, "termenii și condițiile", "terms of service", "Nutzungsbedingungen"),
            (Terms.Agreement3, "noastre și recunoașteți că ați citit și înțeles", "and acknowledge that you have read and understand our", "einverstanden und bestätigen, dass Sie unsere"),
            (Terms.Agreement4, "politica noastră de confidențialitate", "privacy policy", "Datenschutzrichtlinie"),
            (Terms.Agreement5, ".", ".", " gelesen und verstanden haben."),
