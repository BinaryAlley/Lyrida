...
public class TranslationService : ITranslationService
{
    ...
    public TranslationService(IAppConfig appConfig)
    {
        ...
        translations = new TranslationsCollection
        {
            ...
            (Terms.CannotRevert, "Nu veți putea anula această operațiune!", "You will not be able to revert this operation!", "Sie werden diese Operation nicht rückgängig machen können!"),
            (Terms.No, "Nu", "No", "Nein"),
            (Terms.Yes, "Da", "Yes", "Ja"),
            ...
            (Terms.DataSources, "Surse de date", "Data sources", "Datenquellen"),
            ...
            (Terms.LocalFileSystem, "Sistem De Fișiere Local", "Local File System", "Lokales Dateisystem"),
            (Terms.Title, "Titlu", "Title", "Titel"),
            (Terms.DescriptionTitle, "Titlul afișat pentru sursa de date selectată", "The title displayed for the selected data source", "Der angezeigte Titel für die ausgewählte Datenquelle"),
            (Terms.InitialPath, "Calea inițială", "Initial path", "Anfangspfad"),
            (Terms.DescriptionInitialPath, "Locația inițială a sursei de date selectată", "The initial path of the selected data source", "Der anfängliche Pfad der ausgewählten Datenquelle"),
            (Terms.Platform, "Platformă", "Platform", "Plattform"),
            (Terms.DescriptionPlatform, "Sistemul de operare al sursei de date selectată", "The operating system of the selected data source", "Das Betriebssystem der ausgewählten Datenquelle"),
            (Terms.Save, "Salvează", "Save", "Speichern"),
            (Terms.SFTP, "SFTP (Protocol transfer fișiere prin SSH)", "SFTP (SSH File Transfer Protocol)", "SFTP (SSH-Dateiübertragungsprotokoll)"),
            (Terms.FTPS, "FTPS (Protocol transfer fișiere securizat)", "FTPS (File Transfer Protocol Secure)", "FTPS (Dateiübertragungsprotokoll sicher)"),
            (Terms.FTP, "FTP (Protocol transfer fișiere)", "FTP (File Transfer Protocol)", "FTP (Dateiübertragungsprotokoll)"),
            (Terms.DescriptionURL, "Numele gazdei sursei de date selectată", "The hostname of the selected data source", "Der Hostname der ausgewählten Datenquelle"),
            (Terms.DescriptionPort, "Portul sursei de date selectată", "The port of the selected data source", "Der Port der ausgewählten Datenquelle"),
            (Terms.DescriptionUsername, "Numele de utilizator al sursei de date selectată", "The username of the selected data source", "Der Benutzername der ausgewählten Datenquelle"),
            (Terms.DescriptionPassword, "Parola sursei de date selectată", "The password of the selected data source", "Das Passwort der ausgewählten Datenquelle"),
            (Terms.AddDataSourceFirst, "Adăugați o sursă de date mai întâi!", "Add a data source first!", "Zuerst eine Datenquelle hinzufügen!"),
            (Terms.DataSourceSaved, "Sursa de date a fost salvată!", "The data source has been saved!", "Die Datenquelle wurde gespeichert!"),
        };
    }
    #endregion
