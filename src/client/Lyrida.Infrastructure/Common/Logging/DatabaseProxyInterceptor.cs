...
/// <summary>
/// Proxy class providing logging functionality for intercepted interfaces of DAL
/// </summary>
/// <remarks>
/// Creation Date: 20th of June, 2021
/// </remarks>
public class DatabaseProxyInterceptor : IInterceptor
{
    #region ================================================================== FIELD MEMBERS ================================================================================
    private readonly DatabaseAsyncProxyInterceptor asyncProxyInterceptor;
    #endregion
    ...
    public DatabaseProxyInterceptor(DatabaseAsyncProxyInterceptor asyncProxyInterceptor)
    {
