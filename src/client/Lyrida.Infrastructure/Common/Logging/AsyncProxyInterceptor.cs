...
/// <summary>
/// Class for providing asynchronous support for the dynamic proxy interceptor
/// </summary>
/// <remarks>
/// Creation Date: 20th of June, 2021
/// </remarks>
public class AsyncProxyInterceptor : AsyncInterceptorBase
{
    ...
    public AsyncProxyInterceptor(ILoggerManager logger)
    {
        this.logger = logger;
    }
    #endregion
