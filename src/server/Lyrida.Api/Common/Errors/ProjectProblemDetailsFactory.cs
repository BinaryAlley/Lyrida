...
/// </remarks>
public class ProjectProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    public ProjectProblemDetailsFactory(IOptions<ApiBehaviorOptions> options, ITranslationService translationService, IOptions<ProblemDetailsOptions>? problemDetailsOptions = null)
    {
