...
/// </remarks>
/// <typeparam name="T">The type used for the Data array. It should implement <see cref="IStorageDto"/></typeparam>
public sealed class ApiResponse<T> where T : IStorageDto
{
    #region ==================================================================== PROPERTIES =================================================================================
