...
internal sealed class UserRepository : IUserRepository
{
    ...
    {
        return await dataAccess.UpdateAsync(DataContainers.Users, new { data.Password }, new { data.Username });
    }
    ...
    {
        return await dataAccess.DeleteAsync(DataContainers.Users, new { id });
    }
    ...
    {
        return await dataAccess.SelectAsync<UserDto>(DataContainers.Users, new { username });
    }
