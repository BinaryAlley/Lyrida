...
public static partial class Errors
{
    public static class DataAccess
    {
        ...
        public static Error ValidateAccountError => Error.Failure(nameof(ValidateAccountError));
        public static Error ValidatePasswordResetError => Error.Failure(nameof(ValidatePasswordResetError));
