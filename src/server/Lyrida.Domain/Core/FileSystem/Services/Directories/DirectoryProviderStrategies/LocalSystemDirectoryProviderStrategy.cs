...
internal class LocalSystemDirectoryProviderStrategy : ILocalSystemDirectoryProviderStrategy
{
    ...
    /// <param name="permissionsService">Injected service for access permissions functionality</param>
    public LocalSystemDirectoryProviderStrategy(IFileSystem fileSystem)
    {
